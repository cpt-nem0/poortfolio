...
export function MusicNook() {
  ...
  return (
    <group ref={rootRef}>
      ...
      <pointLight castShadow shadow-mapSize={[512, 512]} shadow-bias={-0.004} shadow-camera-near={0.1} position={[20.85, 1.75, 0.65]} color="#ffb35c" intensity={9} distance={7} decay={1.8} />
      ...
      <pointLight castShadow shadow-mapSize={[256, 256]} shadow-bias={-0.004} shadow-camera-near={0.1} position={[21.7, 2.35, 3.0]} color="#ffcf8f" intensity={3.2} distance={3.4} decay={2} />
      ...
      <group position={[17.45, 0, 5.2]}>
        ...
        <pointLight castShadow shadow-mapSize={[256, 256]} shadow-bias={-0.004} shadow-camera-near={0.1} position={[-0.08, 0.85, -0.04]} color="#ffd9a0" intensity={2.2} distance={2.6} decay={2} />
        {/* the 3am coffee mug */}
      ...
      <pointLight castShadow shadow-mapSize={[256, 256]} shadow-bias={-0.004} shadow-camera-near={0.1} position={[16.32, 1.66, 0.77]} color="#ffc87a" intensity={2} distance={2.2} decay={2} />
      ...
      <pointLight castShadow shadow-mapSize={[256, 256]} shadow-bias={-0.004} shadow-camera-near={0.1} position={[21.6, 1.85, 4.9]} color="#ff7a5c" intensity={3} distance={3} decay={2} />
